...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='deit_small_MCTformerV2_patch16_224', type=str, metavar='MODEL',
                        help='Name of model to train')
    parser.add_argument('--input-size', default=224, type=int, help='images input size') #384
    ...
    # * Finetuning params
    parser.add_argument('--finetune', default='pretrained_model/deit_small_patch16_224-cd65a155.pth', help='finetune from checkpoint')
    parser.add_argument('--predtrained_cfg', default=None, help='finetune from checkpoint')

    # Dataset parameters
    parser.add_argument('--data-path', default='data1/VOCdevkit/VOC2012', type=str, help='dataset path')
    ...
    parser.add_argument('--output_dir', default='AETN_results/AETN_outuput',
    ...
    parser.add_argument('--irn_cam_npy_dir', type=str, default=None)
...
def main(args):
    ...
    dataset_train, args.nb_classes = build_dataset(is_train=True, args=args, strong_augment=args.strong_aug)
    ...
    model = create_model(
        args.model,
        pretrained=False,
        pretrained_cfg=args.predtrained_cfg,
    ...
    if args.finetune:
        ...
        if args.finetune.startswith('https') or args.finetune.startswith('pretrained'):
            num_extra_tokens = 1
        else:
        ...
        if (args.finetune.startswith('https') or args.finetune.startswith('pretrained')) and 'MCTformer' in args.model:
    ...
    torch.save({'model': model.module.state_dict()}, output_dir / 'checkpoint.pth')
